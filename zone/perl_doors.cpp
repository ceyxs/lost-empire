...
XS(XS_Doors_DeleteDatabaseEntry); /* prototype to pass -Wmissing-prototypes */
XS(XS_Doors_DeleteDatabaseEntry) {
	dXSARGS;
	if (items != 1)
		Perl_croak(aTHX_ "Usage: Doors::DeleteDatabaseEntry(THIS)");
	{
		Doors *THIS;
...
XS(boot_Doors) {
	...
	newXSproto(strcpy(buf, "DeleteDatabaseEntry"), XS_Doors_DeleteDatabaseEntry, file, "$");
	XSRETURN_YES;
}
